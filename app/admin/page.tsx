...
import { Copy, Check, RotateCw, LogOut } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 font-sans relative">
      <button
        ...
        className="absolute top-8 right-8 text-zinc-600 hover:text-white transition-colors duration-300 flex items-center gap-2 text-sm uppercase tracking-widest"
      >
